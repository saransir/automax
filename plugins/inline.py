    ...
    if '|' in query.query:
        ...
        for movie in movies:
            ...
            if imdb:
               ...
               buttons = [[InlineKeyboardButton("ɢʀᴏᴜᴩ 1", url="https://t.me/+PBGW_EV3ldY5YjJl"), InlineKeyboardButton(text="🎪 ɪɴꜰᴏ ", callback_data=f"imdb#{imdb['imdb_id']}, InlineKeyboardButton("ɢʀᴏᴜᴩ 2", url="https://t.me/+eDjzTT2Ua6kwMTI1")]]
               if not poster:
