...
async def start(bot, cmd):
    ...
    if usr_cmdall1.startswith("/start subinps"):
        ...
        if len(btn) > 15: 
            ...
            keyword = f"{cmd.chat.id}-{cmd.message_id}"
            BUTTONS[keyword] = {
                "total" : len(btns),
                "buttons" : btns
            }
